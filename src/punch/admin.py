...
class AdminModule(AdminNode):
    ...
    def add_url_rule(self, rule, endpoint, view_func, **options):
        ...
        full_endpoint = "%s.%s_%s" % (self.admin.endpoint,
            self.endpoint, endpoint)
#         print "%s%s%s" % (self.admin.url_prefix,self.url_path, rule)
#         print full_endpoint
...
class ObjectAdminModule(AdminModule):
    ...
    def default_rules(self):
        ...
        """
        return [
            ('/', 'list_all', self.list_view.as_view('list_all', self)),
            ('/page/<page>', 'list', self.list_view.as_view('list',
                self)),
            ('/new', 'new', self.form_view.as_view('new', self)),
            ('/<pk>/edit', 'edit', self.form_view.as_view('edit',
                self)),
            ('/<pk>/delete', 'delete', self.delete_view.as_view('delete',
                self)),
        ]
